...
OBJS = myinit.o display.o drawtree.o rotate.o keyboardmouse.o transform.o scale.o reflect.o clip.o tess.o drawcircle.o #sh.o drawcircle.o #put object files here put a space to separate
